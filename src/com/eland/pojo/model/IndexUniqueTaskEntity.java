 ...
 */
public class IndexUniqueTaskEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        IndexUniqueTaskEntity that = (IndexUniqueTaskEntity) o;
        ...
        if (indexName != null ? !indexName.equals(that.indexName) : that.indexName != null)
            return false;
        if (mailList != null ? !mailList.equals(that.mailList) : that.mailList != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (mailList != null ? mailList.hashCode() : 0);
        return result;
    }
}
