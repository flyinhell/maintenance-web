 ...
 */
public class VwIndexSwitchStatusNewEntity {
    ...
    public boolean equals(Object o) {
        ...
        VwIndexSwitchStatusNewEntity that = (VwIndexSwitchStatusNewEntity) o;

        if (actionFlag != null ? !actionFlag.equals(that.actionFlag) : that.actionFlag != null)
            return false;
        if (checkSwitch != null ? !checkSwitch.equals(that.checkSwitch) : that.checkSwitch != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (checkSwitch != null ? checkSwitch.hashCode() : 0);
        return result;
    }
}
